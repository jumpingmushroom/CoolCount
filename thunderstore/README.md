...
OmniCC for Valheim. Every mead and food you cannot use yet gets a **countdown, a radial sweep
and a dimmed icon** right on its slot, in your inventory, in chests and on the hotbar. No more
matching the little status icon in the corner against the bottles in your bag.
...
- Text format, colours by remaining time, sweep, dimming and font size are all configurable.
  The countdown uses the game's own font.
